...
function getStockData(name){
  ...
  return new Promise( (resolve, reject) => {
    request('https://www.quandl.com/api/v3/datatables/WIKI/PRICES.json?date.gte='+ start_date + '&ticker='+ name + '&qopts.columns=date,open&api_key=EnKako51LDRb9jg9JwJH', 
...
export function show(req, res) {
  return getStockData(req.params.id)
    .then(respondWithResult(res))
